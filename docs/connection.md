...
**Белые списки** — позволяет обходить региональные ограничения, когда не открывается ничего кроме ВК и Яндекса. _Некоторое количество трафика входит в тариф, при необходимости его можно докупить._
