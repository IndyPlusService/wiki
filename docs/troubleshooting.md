...
Причины проблем с доступностью могут быть разные. Обычно помогает смена локации и перезапуск нужного приложения/сайта. В случае Телеграм может помочь выключение или выключение Телеграм-прокси, если он у вас есть.
